  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.cleanup.BooleanChecksNotInverted</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.cleanup.BooleanChecksNotInverted`
