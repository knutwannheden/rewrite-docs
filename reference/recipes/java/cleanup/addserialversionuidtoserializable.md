# Add `SerialVersionUID` to a Serializable class when it's missing.
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.cleanup.AddSerialVersionUidToSerializable`
