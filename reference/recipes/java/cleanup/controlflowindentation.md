...
rewrite {
    activeRecipe("org.openrewrite.java.cleanup.ControlFlowIndentation")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.cleanup.ControlFlowIndentation</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.cleanup.ControlFlowIndentation`
