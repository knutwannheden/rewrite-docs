...
Now that `com.yourorg.ChangeDependencyGroupIdExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.16.1 in your build file:
