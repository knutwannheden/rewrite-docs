...
dependencies {
    ...
    implementation("org.openrewrite:rewrite-java:7.16.1")
    runtimeOnly("org.openrewrite:rewrite-java-11:7.16.1")
    runtimeOnly("org.openrewrite:rewrite-java-8:7.16.1")

    // rewrite-maven dependency only necessary for Maven Recipe development
    implementation("org.openrewrite:rewrite-maven:7.16.1")

    // rewrite-yaml dependency only necessary for Yaml Recipe development
    implementation("org.openrewrite:rewrite-yaml:7.16.1")

    // rewrite-properties dependency only necessary for Properties Recipe development
    implementation("org.openrewrite:rewrite-properties:7.16.1")

    // rewrite-xml dependency only necessary for XML Recipe development
    implementation("org.openrewrite:rewrite-xml:7.16.1")

    // For authoring tests for any kind of Recipe
    testImplementation("org.openrewrite:rewrite-test:7.16.1")
}
```
{% endtab %}
